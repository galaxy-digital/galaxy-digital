  ...
  return (
    <div className="home">
      <div className="title-section">
        <Particle />
        <div className="col-8 col-md-8 col-sm-8 container">
      ...
      <div className="col-8 col-md-8 col-sm-8 services">
        <h2>Our Services</h2>
        <div className="items">
          <div>
      ...
      <div className="col-11 col-md-11 col-sm-11 solutions">
        <h2>Our Solutions</h2>
        <div className="items">
          <div>
      ...
      <div className="col-8 col-md-8 col-sm-8 contactus">
